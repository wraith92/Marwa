 ...
 */
final class Version20230520181104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product ADD date_debut DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD date_fn DATE DEFAULT NULL');
    }
